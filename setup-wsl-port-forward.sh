...
# (127.0.0.1 alone is not enough). Prefer: ./setup-wsl-port-forward.cmd as Administrator.
...
echo ""
echo "Run on Windows as Administrator (repo root):"
echo "  .\\setup-wsl-port-forward.cmd"
echo ""
