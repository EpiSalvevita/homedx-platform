...
const img = require('../assets/images/Muster_Perso_Vorne.png')

export default function IDFront({ onNext }: TestSlideProps) {
  ...
  const upload = useCallback(async () => {
    ...
    const res = await uploadAuthPhoto(snapshot, 'identityCard1')
  ...
  return (
    <View flex="1" justifyContent="flex-end">
      <Heading my="2">
        Bitte fotografieren Sie die Vorderseite Ihres Personalausweises.
      </Heading>
      <ListView
        data={[
